      ...
      <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
          ...
          <div class="inner cover">
            <h1 class="cover-heading">Artificial Intelligence?</h1>
			<div class='col-sm-6 twocolumn'>
			<p class='lead'>
          ...
          <div class="mastfoot gradient-border">
            <div class="inner">
              <p>Flai Technologies B.V. Amsterdam 2016 KVK 1234512345</p>
            </div>
          </div>
